...
<form action="<?= site_url("training/exam-exercise/submit-assessment/{$examExercise['id']}") ?>" method="post">
	<?= _csrf() ?>
	<?= _method('put') ?>
	<div class="card mb-3">
		<div class="card-body">
				...
				<div class="card mb-2 border-primary">
					...
					<div class="card-footer pt-2">
						...
						<div class="form-group">
							...
							<textarea class="form-control" id="assessment-note-<?= $answer['id'] ?>" name="assessments[<?= $answer['id'] ?>][assessment_note]" maxlength="500" rows="1"
									  placeholder="Enter exam note"><?= set_value('assessments[' . $answer['id'] . '][assessment_note]', $answer['assessment_note'], $answer['assessment_note']) ?></textarea>
