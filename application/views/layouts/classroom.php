...
<div class="d-flex" id="classroom-wrapper">
    <!-- Sidebar -->
    <?php $this->load->view('layouts/classroom/_sidebar', $data) ?>
    <!-- /#sidebar-wrapper -->

    <!-- Page Content -->
    <div id="classroom-content-wrapper">
		<?php $this->load->view('layouts/classroom/_header') ?>
        ...
        <div class="main-panel">
            ...
            <?php $this->load->view('layouts/classroom/_footer') ?>
        </div>
    </div>
