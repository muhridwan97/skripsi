<form action="<?= site_url('agenda/save') ?>" method="POST" enctype="multipart/form-data" id="form-agenda">
    <?= _csrf() ?>
    <div class="card mb-3">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mt-3">
                ...
                <button type="submit" class="btn btn-success mr-2" data-toggle="one-touch" data-touch-message="Saving...">Save Agenda</button>
            </div>
        </div>
    </div>
</form>
