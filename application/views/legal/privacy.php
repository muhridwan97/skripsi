<article>
    <h3 class="font-weight-bold">Privacy Policy of <?= $this->config->item('app_name') ?></h3>
    <p class="text-fade">Last updated 20 April 2020</p>

    <p>
        Company Name operates the <?= $this->config->item('app_name') ?> website, which provides the SERVICE.
    </p>
    <p>
    ...
    <h5 class="mt-4 font-weight-bold">Information Collection and Use</h5>
    <p>
    ...
    <h5 class="mt-4 font-weight-bold">Log Data</h5>
    <p>
    ...
    <h5 class="mt-4 font-weight-bold">Cookies</h5>
    <p>
    ...
    <h5 class="mt-4 font-weight-bold">Service Providers</h5>
    <p>
    ...
    <h5 class="mt-4 font-weight-bold">Security</h5>
    <p>
    ...
    <h5 class="mt-4 font-weight-bold">Links to Other Sites</h5>
    <p>
    ...
    <h5 class="mt-4 font-weight-bold">Changes to This Privacy Policy</h5>
    <p>
    ...
    <p class="my-5">
        ...
        <a href="<?= site_url('contact') ?>">Contact Us</a> or learn more in
