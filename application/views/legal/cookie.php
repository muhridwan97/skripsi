<article>
    <h3 class="font-weight-bold">Cookie Policy for <?= $this->config->item('app_name') ?></h3>
    <p class="text-fade">Last updated 20 April 2020</p>

    <p>
        This is the Cookie Policy for <?= $this->config->item('app_name') ?>, accessible from <?= site_url('/') ?>
    </p>

    <h5 class="mt-4 font-weight-bold">What Are Cookies</h5>
    <p>
    ...
    <h5 class="mt-4 font-weight-bold">How We Use Cookies</h5>
    ...
    <h5 class="mt-4 font-weight-bold">Disabling Cookies</h5>
    ...
    <h5 class="mt-4 font-weight-bold">The Cookies We Set</h5>
    <ul>
        <li>
    ...
    <h5 class="mt-4 font-weight-bold">Third Party Cookies</h5>
    <p>
